...
export class EncounterService {
    ...
    async searchByEncounterIdentifier(identifier: string): Promise<EncounterDetailResponse | null> {
        ...
        if (encounterDetailData1.towingVehicleEncounterID === null) {
            ...
            const encounterDetailData2 = await this.encounterProvider.getEncounterTrailer(encounterDetailData1.encounterIdentifier);
            ...
            if (encounterDetailData2 !== null) {
                ...
                const encounterDetailData3 = await this.encounterProvider.getEncounterTrailer(encounterDetailData2.encounterIdentifier);
            ...
            const encounterDetailData2 = await this.encounterProvider.getEncounterByIdentifier(encounterDetailData1.towingVehicleEncounterID);
            ...
            if (encounterDetailData2?.towingVehicleEncounterID === null) {
                ...
                const encounterDetailData3 = await this.encounterProvider.getEncounterTrailer(encounterDetailData1.encounterIdentifier);
                ...
                const encounterDetailData3 = await this.encounterProvider.getEncounterByIdentifier(encounterDetailData2.towingVehicleEncounterID);
